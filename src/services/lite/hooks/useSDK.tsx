...
const useSDK = () => {
  ...
  const getTrade = useCallback(
    async (fromToken: Token, toToken: Token, fromAmount: ethers.BigNumber, provider: ethers.providers.BaseProvider) => {
      if (provider) {
  ...
  const calculateLimitOrderReturn = (fromToken: Token, toToken: Token, fromAmount: ethers.BigNumber, price: string) => {
