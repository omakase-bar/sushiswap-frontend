...
import { ButtonError, ButtonLight, ButtonPrimary, ButtonConfirmed } from "../../components/Button/secondary";
      ...
      <Wrapper id="swap-page">
        ...
        <BottomGrouping>
          {!account ? (
            ...
            //   className="w-full flex justify-center py-4 px-4 border border-transparent font-medium rounded-md text-orange-600 bg-orange-100 hover:bg-orange-200 focus:outline-none focus:border-orange-400 focus:shadow-outline-orange active:bg-orange-200 transition duration-150 ease-in-out"
            // >
            //   Connect Wallet
            // </button>
            //
