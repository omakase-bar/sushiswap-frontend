...
const CountDown = ({ start }) => {
  ...
  return (
    <span>
      {state.days || "0"} Days {state.hours || "00"} : {state.minutes || "00"} :{" "}
      {state.seconds || "00"}
    </span>
  );
};
...
const CurrentMenu = ({ scrollToCurrent }) => {
  return (
    <>
      <div className="sushi-relative sushi-w-4/5 md:sushi-w-1/3 sushi-mx-auto sushi-pl-6">
        <div className="sushi-border sushi-border-gray-200 sushi-rounded-lg sushi-shadow-sm sushi-divide-y sushi-divide-gray-200">
          <div className="sushi-p-6">
            ...
            <p className="sushi-mt-4 sushi-text-sm sushi-leading-5 sushi-text-gray-500">
              This week's special menu, harvest bonus rewards while they last!
              Regular fees generated by providing liqudity still apply.
            </p>
                  ...
                  return (
                    <img
                      ...
                      src={`https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/ethereum/assets/${isAddress(
                        _.find(supportedPools, ["pid", Number(pid)])
                          ?.tokenAddresses["1"]
                      )}/logo.png`}
                      onError={(e) => {
...
const PreviousMenus = ({ scrollToPrevious }) => {
  return (
    <>
      <div className="sushi-relative sushi-w-4/5 md:sushi-w-1/3 sushi-mx-auto sushi-pl-6">
        <div className="sushi-border sushi-border-gray-200 sushi-rounded-lg sushi-shadow-sm sushi-divide-y sushi-divide-gray-200">
