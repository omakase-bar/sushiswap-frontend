  ...
  const grants = [
    {
      ...
      type: "20,000 - 30,000 SUSHI",
      remaining: "50:00:00",
    },
    {
      status: "Open",
      title: "Analytics Smartphone App",
    ...
    {
      status: "Open",
      title: "10 Blog Posts and Tutorials",
    ...
    {
      status: "Open",
      title: "1,000 Memes and Distribution",
    ...
    {
      status: "Open",
      title: "Feature Addition: Loading Indicator for Sushiswap.org",
    ...
    <div className="sushi-bg-white sushi-shadow sushi-overflow-hidden sushi-rounded-md">
      <div className="sushi-bg-white sushi-px-6 sushi-pt-5 sushi-border-b sushi-border-gray-200 sm:sushi-px-6">
        <h3 className="sushi-text-lg sushi-leading-6 sushi-font-medium sushi-text-gray-900">
          Accepted Grants: Request for Proposals
        </h3>
                    ...
                    <div className="sushi-min-w-0 sushi-flex-1 sushi-px-4 md:sushi-grid md:sushi-grid-cols-2 md:sushi-gap-3">
                      <div>
                        <div className="sushi-leading-5 sushi-font-medium sushi-text-gray-600 sushi-truncate">
                          <span className="sushi-mr-3 sushi-inline-flex sushi-items-center sushi-px-2.5 sushi-py-0.5 sushi-rounded-md sushi-text-sm sushi-font-medium sushi-leading-5 sushi-bg-green-100 sushi-text-green-800">
                            {grant.status}
                          </span>
                          {grant.title}
                        </div>
                        <div className="sushi-mt-2 sushi-flex sushi-items-center sushi-text-sm sushi-leading-5 sushi-text-gray-500">
                          <span className="sushi-truncate">{grant.details}</span>
                        </div>
                      </div>
