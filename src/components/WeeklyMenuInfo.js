...
import Demo from "../assets/menu-week.jpg";
          ...
          <div className="sushi-pt-10 sushi-pb-12 sushi-px-6 sm:sushi-pt-16 sm:sushi-px-16 lg:sushi-py-16 lg:sushi-pr-0 xl:sushi-py-20 xl:sushi-px-20">
            <div className="lg:sushi-self-center">
              ...
              <p className="sushi-mt-4 sushi-text-base sushi-leading-6 sushi-text-gray-900">
                ...
                liquidity providers for certain pairs. A community voting
                process determines which pairs are featured for which week, they
                may choose to keep some or change others. Users will always be
                able to harvest SUSHI from all previously featured pools.
              </p>
              <button
