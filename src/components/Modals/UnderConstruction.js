            ...
            <div className="sushi-mt-3 sushi-text-center sm:sushi-mt-0 sm:sushi-ml-4 sm:sushi-text-left">
              ...
              <div className="sushi-mt-2">
                <p className="sushi-text-sm sushi-leading-5 sushi-text-gray-500">
                  Many features are currently being added refactored and polished by chefs hard at work. Use at your own
                  risk. Feel free to use the{" "}
                  <a
                  ...
                  >
                    <span>Sushiswap Classic Interface</span>
                  </a>{" "}
                  for your functional needs.
                </p>
                <br />
                <p className="sushi-text-sm sushi-leading-5 sushi-text-gray-500">
                  This site would not have been possible without the open source community, please reference our
                  contributors and licenses on the About page.
                </p>
              </div>
            </div>
          </div>
