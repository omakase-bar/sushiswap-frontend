    ...
    <>
      ...
      >
        <div className="sushi-flex sushi-items-center sushi-flex-shrink-0">
          {logo && <img className="sushi-h-8 sushi-w-auto" src={logo} alt="logo" />}
          <h1
            className={
              "sushi-text-lg sushi-font-medium sushi-leading-6 sushi-text-gray-900 sm:sushi-truncate " +
              (logo && "sushi-ml-2")
            }
          >
            {title}
        ...
        <div className="sushi-mt-4 sushi-flex sm:sushi-mt-0 sm:sushi-ml-4">
          <span className="sushi-w-full md:sushi-w-auto sushi-order-1 sushi-ml-3 sushi-shadow-sm sushi-rounded-md sm:sushi-order-0 sm:sushi-ml-0">
            ...
            >
              Share
              <svg fill="none" viewBox="0 0 24 24" stroke="#b4bfd8" class="sushi-share sushi-w-6 sushi-h-6 sushi-ml-2">
                <path
