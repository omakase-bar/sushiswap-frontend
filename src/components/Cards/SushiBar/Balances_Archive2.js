  ...
  return (
    <>
      <div className="bg-white border border-gray-200 shadow overflow-hidden sm:rounded-lg">
        ...
        <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
          <div className="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-no-wrap">
            ...
            <div className="ml-4 mt-4 flex-shrink-0">
              ...
              <p className="mt-1 text-sm text-right leading-5 text-gray-500">{totalSushiBalanceUSD}</p>
            </div>
          </div>
        </div>
        {/* Content */}
        <div className="px-4 py-5 sm:p-0">
          <dl>
            <div className="border-b border-gray-200 sm:grid sm:grid-cols-7 sm:gap-4 sm:px-6 sm:py-5">
              <dt className="text-sm leading-5 font-medium text-gray-500 sm:mt-0 sm:col-span-2">Harvestable</dt>
              <dd class="flex space-x-4 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-3">
              ...
              <dd class="flex justify-end space-x-4 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                <button
                  type="button"
            ...
            <div className="border-b border-gray-200 sm:grid sm:grid-cols-7 sm:gap-4 sm:px-6 sm:py-5">
              <dt className="text-sm leading-5 font-medium text-gray-500 sm:mt-0 sm:col-span-2">Locked</dt>
              <dd class="flex space-x-4 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-3">
                <span class="flex-grow">
                  <div className="text-right">{totalNotStaked ? `0.0000 SUSHI` : ""}</div>
                  <div className="text-right text-gray-500">{totalNotStaked ? `$0.0000` : ""}</div>
                </span>
              </dd>
              <dd class="flex justify-end space-x-4 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                <button
            ...
            <div className="border-b border-gray-200 sm:grid sm:grid-cols-7 sm:gap-4 sm:px-6 sm:py-5">
              <dt className="text-sm leading-5 font-medium text-gray-500 sm:mt-0 sm:col-span-2">Unstaked</dt>
              <dd class="flex space-x-4 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-3">
                <span class="flex-grow">
                  <div className="text-right">
                    {totalNotStaked ? `${Number(getBalanceNumber(totalNotStaked)).toFixed(4)} SUSHI` : ""}
                  </div>
            ...
            <div className="border-b border-gray-200 sm:grid sm:grid-cols-7 sm:gap-4 sm:px-6 sm:py-5">
              <dt className="text-sm leading-5 font-medium text-gray-500 sm:mt-0 sm:col-span-2">
                <div>Staked</div>
                {/* <div>Est. 15% APR</div> */}
              </dt>
              <dd class="flex space-x-4 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-3">
